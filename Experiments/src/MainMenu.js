...
(function (EXP) {
    var MainMenu = (function (_super) {
        ...
        MainMenu.prototype.create = function () {
            ...
            alert.play();
            this.makeStateSwitchButton("Hello", EXP.Test);
            this.makeStateSwitchButton("Firestarter", EXP.Firestarter);
        ...
        MainMenu.prototype.makeStateSwitchButton = function (caption, state) {
            var pxSize = 32;
